...
>
> Artículos fuente: [Mejora de rendimiento](https://farming-simulator.com/newsArticle.php?&news_id=291) · [Fertilización](https://farming-simulator.com/newsArticle.php?&news_id=292) · [Malas hierbas](https://farming-simulator.com/newsArticle.php?&news_id=293) · [Arado y cultivado](https://farming-simulator.com/newsArticle.php?&news_id=294) · [Rodillos](https://farming-simulator.com/newsArticle.php?&news_id=295) · [Trituradoras](https://farming-simulator.com/newsArticle.php?&news_id=296) · [Siembra](https://farming-simulator.com/newsArticle.php?&news_id=317) · [Piedras](https://farming-simulator.com/newsArticle.php?&news_id=318)
...
COSECHA
  └─ TRITURADORA (si quedan rastrojos) ← ANTES de cultivar
...
| --- | --- | --- |
| Rastrojos tras cereal/oleaginosa | Después de cosechar, antes de cultivar | **Trituradora** (categoría Trituradoras) |
| Viñedos / olivos | Después de cultivar, cuando crece la hierba de nuevo | Trituradora → corta la hierba y evita penalización |
| Tocones y ramas forestales | Después de talar | Trituradora forestal (Equipamiento forestal) |

### Truco de eficiencia
>
> Puedes enganchar la **trituradora delante del tractor** y el **cultivador detrás**. Así realizas ambas operaciones en una sola pasada.
...
## PASO 4 — Encalado (Liming) — *Corrección del pH del suelo*

**¿Qué es?** Con cada cosecha, el suelo pierde minerales y se acidifica. La **cal** neutraliza esa acidez y restaura el pH correcto para que los cultivos absorban bien los nutrientes. Sin ella, aunque fertilices, el suelo no aprovecha bien el abono.

**Cuándo toca:** Cada **3 cosechas** aproximadamente.

### Cómo saber si tu campo necesita cal

Hay dos formas de comprobarlo:

- **Mapa** → activar el filtro **"Soil Composition"** (composición del suelo) — el campo aparece destacado si necesita cal
- **Campo** → pulsar `[I]` en el campo → la ficha de información indica directamente si el pH es bajo

### Efecto de no encalar

> Penalización de rendimiento activa en todos los cultivos de ese campo hasta que apliques cal. No es inmediata — el suelo se va degradando poco a poco.

### Cómo aplicar la cal

| Qué necesitas | Dónde encontrarlo |
| --- | --- |
| **Esparcidor de cal (Lime Spreader)** | Tienda → categoría "Lime" |
| **Cal (Lime)** a granel o en sacos (Lime Bigbag) | Tienda → sección "Pallets / Bigbags" |

- Puedes encalar **antes o después de cultivar** — el orden no importa.
- **Truco:** algunos esparcidores de fertilizante sólido más caros **también pueden aplicar cal** — así combinas las dos tareas en una sola pasada y ahorras tiempo.
...
| **Triturado de rastrojos** | +2,5% | Justo tras cosechar | No, pero recomendado |
...
> **Campo perfecto = Triturado + Encal (c/ 3) + 2×Fertilizado + Sin hierbas + Rodillo → hasta el doble de cosecha base**
...
| **RPM + Zona ECO** | En triturado de rastrojos, esparcido de cal y fertilización (trabajo ligero), mantén el motor en zona ECO para ahorrar combustible |
...
- [ ] ¿Quedaron rastrojos? → **Trituradora de rastrojos** antes de cultivar
